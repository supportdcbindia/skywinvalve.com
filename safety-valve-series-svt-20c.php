        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="caption">
                    ...
                    <h1 class="fz-40">Safety Valve - Series SVT 20/C</h1>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="swiper-container">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="img">
                                        <a href="assets/imgs/innerpage/product/detail/safety-valve/safety-valve-series-svt-20c.webp" class="popup-image gallery-item" >
                                        <img src="assets/imgs/innerpage/product/detail/safety-valve/safety-valve-series-svt-20c.webp" alt="">
                                       </a>
                                    </div>
                                </div>
                ...
                <div class="product-info">
                    <div class="top-info">
                        <div class="d-flex align-items-center">
                            <div>
                                <h4 class="line-height-1">DIMENSIONS</h4>
                            </div>
                        </div>
                        <div class="table-detail mt-30 table-responsive">
                            <table class="pro-table">
                                <thead>
                                    <tr>
                                        <th>Valve Size Inlet x Outlet </th>
                                        <td>A ±3.0</td>
                                        <td>B ±3.0</td>
                                        <td>C ±3.0</td>
