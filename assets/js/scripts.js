...
$(function () {
    ...
    wind.on("scroll", function () {
        ...
        if (bodyScroll > 300) {
            ...
            logo.attr('src', 'assets/imgs/logo/skywin-logo.webp');
    ...
    $('[data-carousel="swiper"]').each(function () {
        ...
        if ($(this).hasClass('work-crus2')) {
            var conf = {
                ...
                pagination: {
                    el: ".blog-list-half .swiper-pagination",
                    clickable: true,
                },

                navigation: {
                    nextEl: '.blog-list-half .swiper-button-next',
                    prevEl: '.blog-list-half .swiper-button-prev'
                }
            };
        };
...
function startCounters() {
   ...
   document.getElementById("expYears").innerHTML = 16;
   document.getElementById("projects").innerHTML = 4;
   document.getElementById("customers").innerHTML = 9;
   document.getElementById("awards").innerHTML = 12;
}

$(window).on("scroll", function () {
   const section = document.querySelector(".testim-crv2");
   if (!section) return;
...
if ($('.industris-slide').length) {
    new Swiper('.industris-slide', {
        slidesPerView: 1,
        spaceBetween: 30,
        breakpoints: {
        ...
        pagination: {
            el: '.industris-slide .swiper-pagination',
            clickable: true,
        },
        navigation: {
...
if ($('.testim-swiper').length) {
    new Swiper('.testim-swiper', {
        slidesPerView: 1,
        spaceBetween: 0,
        breakpoints: {
